...
struct SchoolKgTestView: View {
            ...
            ZStack{
                ...
                if isShowingCorrect {
                    ...
                    Color.black.opacity(0.2).edgesIgnoringSafeArea(.all)
                        ...
                        .overlay(
                            SCorrectSchoolKgTest(isPresentedRepeat: $isShowingCorrect)
                                .padding()
                        )} // End of if stetment
                ...
                if isShowingFalse {
                    Color.black.opacity(0.2).edgesIgnoringSafeArea(/*@START_MENU_TOKEN@*/.all/*@END_MENU_TOKEN@*/)
                        ...
                        .overlay(
                            SFalseSchoolKgTest(isPresentedNext: $isShowingFalse)
                                .padding()
                        )} // End of if stetment
    ...
    struct SCorrectSchoolKgTest: View {
    ...
    struct SFalseSchoolKgTest: View {
